//Program to demonstrate protected mode of inheritance in single inheritance
...
class sub :protected Abase
{
int y; // protected section of sub class will have z,proread(),prodisplay()
//read(),display();
public:
void input()
{
